...
const UserProfile = () => {
	...
	return (
      ...
      <Card style={{margin:3,marginTop:70}}>
		 <View style={{flexDirection:"row", backgroundColor:"#D1FAE0", padding:8,margin:5}}>
		 <MaterialIcons name="email" size={40} color="black" />
		 <Text style={{fontSize:18, marginTop:7, marginLeft:6}}>Email@gmail.com</Text>
		 </View>
		 </Card>
		 ...
		 <Text style={{fontSize:18, marginTop:7, marginLeft:27}}>30000</Text>
		 </View>
		 </Card>
		 
		

		 <View style={{flexDirection:'row',justifyContent:'space-around',padding:20,marginTop:160}}>
		<Button icon="exit-to-app" mode="contained" onPress={() => console.log('Pressed')}>
            Sign out
        </Button>
		 </View>
		</NativeBaseProvider>
