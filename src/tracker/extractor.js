        ...
        SmsModule.list(
            ...
            (count, smsList) => {
                ...
                arr.map(function (object, i_arr) {
                    ...
                    let category = category_obj ? category_obj.name : null;
                    output.push({
                        ...
                        receiver: receiver,
                        balance_after: schema.attributes.extractors.balance_after != null ? body.match(schema.attributes.extractors.amount.regex)[schema.attributes.extractors.amount.index] : 'others',
                        category: category,
                    })
